...
# 配置区域
# =========================
INPUT_JSON = "/data01/cd_workspace/Detect_SDC/Qwen2.5-VL-7B/LingoQA/json/detect_LingoQA_Qwen_with_sem_labeled.jsonl"
...
def main():
    ...
    for sample_idx, sample in enumerate(tqdm(data, desc="Processing samples")):
        ...
        # if sample_idx >= 10000 and sample_idx < 15000:
        #     if dtel_score == 0:
        #         continue
    ...
    train_df.to_csv(os.path.join(output_dir, "Qwen2.5_LingoQA_train_set.csv"), index=False, encoding="utf-8-sig")
    valid_df.to_csv(os.path.join(output_dir, "Qwen2.5_LingoQA_valid_set.csv"), index=False, encoding="utf-8-sig")
